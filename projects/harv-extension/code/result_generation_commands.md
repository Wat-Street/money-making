...
Overall structure:
- Main run (Intraday_benchmark.py) returns predictions and projects\harv-extension\code\outputs\intraday\tables\Section_1_table_1a_overall.csv, and runs projects\harv-extension\code\Helpers_for_paper_export_scripts\Section_5\build_section5_tables.py
- This action automatically populates a lot of feeder csvs that we need (all of them can be found under projects\harv-extension\code\outputs\intraday\tables)
...
- projects\harv-extension\code\outputs\intraday\tables: contain the feeder csvs that paper_export scripts use
- all visual results/outputs can be found in: projects\harv-extension\code\paper
...
python code/paper_export/Section_1/latex_table/Section_1_table_1_overall.py `
  --csv code/outputs/intraday/tables/Section_1_table_1a_overall.csv `
  --out code/paper/latex/Section_1_table_1a_overall.tex `
  --context intraday
...
python code/paper_export/Section_2/latex_table/Section_2_table_2_regimes.py `
  --csv code/outputs/intraday/tables/Section_2_regimes.csv `
  --out code/paper/latex/Section_2_table_2_regimes.tex `
  --include-variants
...
python code/paper_export/Section_3/figure/Section_3_fig_2_temporal_stability.py `
  --pred-dir code/outputs/intraday/predictions `
  --asset SPY `
  --models HAR,PM,CP `
  --window 78 `
  --smooth ema `
...
python code/paper_export/Section_5/figure/Section_5_fig_4_capacity_curve.py `
  --csv code/outputs/intraday/tables/Section_5_fig_4_capacity_curve.csv `
  --outdir code/paper/figures
...
python code/paper_export/Section_5/figure/Section_5_fig_5_pm_modifiers_efficacy.py `
  --tables-dir code/outputs/intraday/tables `
  --outdir code/paper/figures `
  --style mono
...
python code/paper_export/Section_5/latex_table/Section_5_table_4_random_controls.py `
  --in code/outputs/intraday/tables/Section_5_table_4_random_controls.csv `
  --outdir code/paper/latex `
  --scope intraday
...
python code/paper_export/Section_6/figure_and_latex_table/Section_6_fig_7_and_table_5_asset_groups.py `
  --pred-dir code/outputs/intraday/predictions `
  --tables-dir code/outputs/intraday/tables `
  --out-tex code/paper/latex/Section_6_table_5_asset_groups.tex `
  --out-fig code/paper/figures/Section_6_fig_7_asset_groups.pdf `
  --baseline HAR `
  --models PM,CP `
  --auto-build
