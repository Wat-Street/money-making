...
\resizebox{0.86\textwidth}{!}{\input{paper_assets/tables/Appendix_Table_C1_feature_count.tex}}
\end{center}}
...
\scriptsize
\renewcommand{\arraystretch}{1.08}
\resizebox{0.90\textwidth}{!}{\input{paper_assets/tables/Appendix_Table_C2_contiguous_windows.tex}}
\end{center}}
...
\scriptsize
\renewcommand{\arraystretch}{1.08}
\resizebox{0.84\textwidth}{!}{\input{paper_assets/tables/Appendix_Table_C3_prime_nonprime.tex}}
\end{center}}
...
\scriptsize
\renewcommand{\arraystretch}{1.08}
\resizebox{0.88\textwidth}{!}{\input{paper_assets/tables/Appendix_Table_C4_random_controls.tex}}
\end{center}}
...
\scriptsize
\renewcommand{\arraystretch}{1.08}
\resizebox{0.62\textwidth}{!}{\input{paper_assets/tables/Appendix_Table_C5_external.tex}}
\end{center}}
